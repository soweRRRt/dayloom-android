...
Dayloom — локальное Android-приложение, которое объединяет привычки, планирование, списки, желания и защищённое хранилище в одном спокойном интерфейсе. Репозиторий содержит production-ready фундамент первого этапа и сквозные сценарии привычек, календарного планирования и гибких списков.

> Статус: Phase 1 / foundation + Habits, Planner and Lists vertical slices. Привычки и планы можно вести в едином календаре, а списки — наполнять, отмечать и сортировать; данные сохраняются между запусками. Вишлист и Vault пока показывают осмысленные preview/empty states.
...
- Живые показатели привычек, планов и открытых пунктов списков на главном экране.
