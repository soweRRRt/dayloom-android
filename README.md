...
> Статус: Phase 1 / foundation + Habits, Planner, Lists and Wishlist vertical slices. Привычки и планы можно вести в едином календаре, списки — наполнять, отмечать и сортировать, а для желаний — создавать отдельные цели и вручную учитывать накопления. Все данные сохраняются между запусками. Vault пока показывает безопасный locked state.
