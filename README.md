...
- Единый локальный движок напоминаний на WorkManager: переживает перезапуск устройства, перепланирует активные планы и отменяет уведомление после выполнения или удаления.
