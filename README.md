...
- Создание и редактирование привычек, выбор дней недели, архивирование, серии выполнения, локальные изображения и сохранение.
...
- Гибкие списки четырёх типов с количеством, заметками, отметками выполнения и ручной сортировкой пунктов.
- Отдельные финансовые цели с приоритетом, произвольной валютой, прогрессом и историей ручных пополнений.
