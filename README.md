...
- Создание, редактирование, выполнение и удаление планов с восстановлением после перезапуска и необязательным локальным напоминанием в выбранное время.
...
- Локальные обложки желаний: системный выбор изображения, приватная копия до 10 МБ, замена и удаление; два демонстрационных желания получают готовые обложки.
