...
Dayloom — локальное Android-приложение, которое объединяет привычки, планирование, списки, желания и защищённое хранилище в одном спокойном интерфейсе. Репозиторий содержит production-ready фундамент первого этапа и первый сквозной пользовательский сценарий привычек.

> Статус: Phase 1 / foundation + Habits vertical slice. Привычку уже можно создать и отметить выполненной за сегодня; данные сохраняются между запусками. Планировщик, списки, вишлист и Vault пока показывают осмысленные preview/empty states.
...
- Создание ежедневных привычек, отметка выполнения за сегодня и локальное сохранение результата.
